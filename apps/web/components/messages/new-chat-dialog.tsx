...
import { getTenantUsers, getLeadsForMessaging, getOrCreateConversation, getOrCreateLeadConversation } from "@/app/actions/messages"
            ...
            <DialogContent className="sm:max-w-[425px] p-0 overflow-hidden rounded-[2rem] border-none shadow-2xl">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <Tabs value={activeTab} onValueChange={(v: any) => setActiveTab(v)} className="w-full">
                        <TabsList className="grid w-full grid-cols-2 p-1 bg-gray-100 rounded-2xl h-12">
