    ...
    const handleGenerate = async (isRegenerate = false) => {
        ...
        try {
            ...
            if ((result as any).warning) {
                toast.error((result as any).warning, { duration: 10000 });
            } else {
                            ...
                            {loading ? (
                                ...
                                filteredProperties.map((prop) => (
                                    <Card
                                        ...
                                        className={`group cursor-pointer border-2 transition-all duration-300 rounded-[2rem] overflow-hidden ${selectedProperty?.id === prop.id
                                        ...
                                        <CardContent className="p-0">
                                            <div className="h-40 relative">
                                                {prop.property_media?.[0]?.url ? (
                                                    <img src={prop.property_media[0].url} className="w-full h-full object-cover" alt={prop.title} />
                                                ) : (
                                    ...
                                    <div className="grid gap-2">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={`flex items-center gap-4 p-4 rounded-2xl transition-all text-left border-2 ${contentType === t.id
                                            ...
                                            >
                                                <div className={`h-10 w-10 rounded-xl flex items-center justify-center ${contentType === t.id ? 'bg-purple-600 text-white' : 'bg-white text-gray-400'
                                                    }`}>
                                    ...
                                    return (
                                        <div key={platform} className="flex items-center justify-between p-4 rounded-3xl bg-gray-50 border border-gray-100 transition-all hover:bg-gray-100/50">
                                            <div className="flex items-center gap-4">
                                                <div className={`h-11 w-11 rounded-2xl flex items-center justify-center ${platform === 'instagram' ? 'bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-600' :
                                ...
                                {['instagram', 'tiktok', 'linkedin'].map((p) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-6 py-3 rounded-2xl text-xs font-black transition-all border-2 flex items-center gap-2 ${!isLinked ? 'bg-gray-50 border-gray-50 text-gray-300 cursor-not-allowed opacity-50' :
