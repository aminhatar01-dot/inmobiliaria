...
export default function PropertyEditForm({ property }: Props) {
    ...
    const [formData, setFormData] = useState({
        ...
        automation_settings: (property as any).automation_settings?.rules ? (property as any).automation_settings : {
            rules: [
                {
                    ...
                    actionType: 'whatsapp',
                    trigger: 'new_inquiry',
                    message: `Hola! Gracias por tu interés en ${property.title}. Me gustaría invitarte a una visita personalizada para que conozcas todos los detalles. ¿Qué día te queda mejor?`,
                    enabled: false
                }
            ]
        }
